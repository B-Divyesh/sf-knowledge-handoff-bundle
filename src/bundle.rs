...
<body><a class="skip" href="#main">Skip to handoff</a><aside class="tape-head" aria-label="Bundle metadata"><span>KHB // recipient copy</span><span>Generated {date}</span></aside>
<main id="main" tabindex="-1"><section class="cover"><p class="eyebrow">Project handoff · source-of-truth bundle</p><h1>{title}</h1><p class="summary">{summary}</p><dl class="owner"><div><dt>Prepared by</dt><dd>{owner}</dd></div><div><dt>Prepared</dt><dd>{prepared}</dd></div><div><dt>Bundle health</dt><dd id="bundle-health">{health}</dd></div></dl></section>
